...
////////////////////////////////////////
// Commented this out because it disables writing to the console. In C/C++/Cmake I know how to wrangle
// this so it works when in a debug build and not when in a release build, but whatever, I'm lazy.
//
//extern (Windows)
//int WinMain(
//	HINSTANCE hInstance,
...
void print_gl_version_of_context()
{
	int major = 0;
	int minor = 0;
...
int main(
	...
	writeln("Support: ", support);
	print_gl_version_of_context();
	...
	while (!done) {
		...
		// 2. Show a simple window that we create ourselves. We use a Begin/End pair to created a named window.
		{
			...
			igText("Application average %.3f ms/frame (%.1f FPS)", 1000.0f / igGetIO().Framerate, igGetIO()
					.Framerate);
			igEnd();
		}
	...
	// MessageBoxA(null, "Hello".toStringz(), null, MB_ICONINFORMATION);
	return 0;
}